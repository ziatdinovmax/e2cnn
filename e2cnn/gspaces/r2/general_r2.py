...
class GeneralOnR2(GSpace):
    def __init__(self, fibergroup, name):
        r"""
    ...
    def build_kernel_basis(self, in_repr, out_repr, sigma, rings, **kwargs):
        r"""
    ...
    @abstractmethod
    def _basis_generator(self, in_repr, out_repr, rings, sigma, **kwargs):
        pass
