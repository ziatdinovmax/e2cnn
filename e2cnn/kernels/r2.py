...
def kernels_SO2_act_R2(in_repr, out_repr, radii, sigma):
    r"""
    ...
    angular_basis = SteerableKernelBasis(
        R2ContinuousRotationsSolution, in_repr, out_repr
    )
...
def kernels_O2_act_R2(in_repr, out_repr, radii, sigma, axis = np.pi / 2):
    r"""
    ...
    angular_basis = SteerableKernelBasis(
        R2FlipsContinuousRotationsSolution, in_repr, out_repr, axis=axis
    )
...
def kernels_CN_act_R2(
    in_repr, out_repr, radii, sigma, max_frequency = None, max_offset = None
):
    r"""
