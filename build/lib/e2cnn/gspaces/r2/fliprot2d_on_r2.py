...
class FlipRot2dOnR2(GeneralOnR2):
    def __init__(
        self, N = None, maximum_frequency = None, axis = np.pi / 2, fibergroup = None
    ):
        r"""
    ...
    def restrict(self, id):
        ...
        if id[0] is None and id[1] == 1:
            ...
            return (
                gspaces.Flip2dOnR2(fibergroup=subgroup, axis=new_axis),
                mapping,
                child,
            )
        elif id[0] is not None:
            return (
                gspaces.FlipRot2dOnR2(fibergroup=subgroup, axis=new_axis),
                mapping,
                child,
            )
        else:
    ...
    def _basis_generator(
        ...
        if self.fibergroup.order() > 0:
            ...
            return kernels.kernels_DN_act_R2(
                in_repr,
                out_repr,
                rings,
                sigma,
            ...
            return kernels.kernels_O2_act_R2(
                in_repr, out_repr, rings, sigma, axis=self.axis
            )
