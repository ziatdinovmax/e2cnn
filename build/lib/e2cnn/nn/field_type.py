...
class FieldType:
    def __init__(self, gspace, representations):
        r"""
    ...
    def get_dense_change_of_basis(self):
        """
    ...
    def get_dense_change_of_basis_inv(self):
        """
    ...
    def transform(self, input, element):
        r"""
        ...
        """
        transformed = self.gspace.featurefield_action(
            input.detach().numpy(), self.representation, element
        )
    ...
    def group_by_labels(self, labels):
        r"""
