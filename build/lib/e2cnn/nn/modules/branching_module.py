...
class BranchingModule(EquivariantModule):
    def __init__(self, in_type, labels, reshuffle = 0):
        ...
        if reshuffle > 0:
            ...
            for l in labels:
                ...
                keys.append(
                    (
                        l,
                        in_type.representations[c].size,
                        in_type.representations[c].name,
                        c,
                    )
                )
                c += 1
    ...
    def _retrieve_subfiber(self, input, l):
        r"""
